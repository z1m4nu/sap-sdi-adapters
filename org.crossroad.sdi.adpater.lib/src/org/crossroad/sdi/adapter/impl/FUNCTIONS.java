...
public enum FUNCTIONS {
	MAX, MIN, SUM, ADD, TO_DECIMAL, ROUND, TO_VARCHAR, TO_INT, TO_TINYINT, TO_INTEGER, TO_SMALLINT, TO_BIGINT, TO_REAL, TO_DOUBLE, MOD, CEIL, LN, LOG, ATAN2, STDDEV, AVG, COUNT, TO_TIMESTAMP;
