...
public final class RemoteSourceDescriptionFactory {
	...
	public static PropertyGroup getMappingProperty() {
		PropertyGroup group = new PropertyGroup(AdapterConstants.KEY_GROUP_DATAMAPPING, "Data mapping");		
		

		PropertyEntry mappingDataChoice = new PropertyEntry(AdapterConstants.KEY_DATAMAPPING, "Use custom data mapping",
				"", false);
		...
		PropertyEntry mappingFile = new PropertyEntry(AdapterConstants.KEY_DATAMAPPING_FILE, "Mapping file", "Mapping file", true);
		mappingFile.setDefaultValue(AdapterConstants.KEY_DATAMAPPING_FILE_DEFAULT);
		group.addProperty(mappingFile);
